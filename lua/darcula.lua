...
M.configure_highlights = function()
  ...
  hi(0, "GitGutterAdd", { bg = color.dark_gray, fg = color.light_olive_green })
  ...
  hi(0, "User4", { bg = color._12, fg = color.bright_sky })
  ...
  hi(0, "lualine_b_diagnostics_hint_inactive", { bg = color._11, fg = color.bright_sky })
  ...
  hi(0, "lualine_b_diff_added_inactive", { bg = color._11, fg = color.light_olive_green })
