---@class Config
---@field theme? string Theme name or path to theme JSON file
---@field override? fun(colors: table): table Function to override colors
---@field opt table Plugin integration options
local config = {
  opt = {
    integrations = {
      telescope = true,
...
M.setup = function(args)
  ...
  -- Load colors from theme file or use defaults
  local color
  if args and args.theme then
    local loader = require("darcula.theme_loader")
    local loaded_colors, err = loader.load(args.theme)
    if loaded_colors then
      -- Merge loaded colors with defaults (allows partial themes)
      local default_colors = require("darcula.default_colors")
      color = vim.tbl_deep_extend("force", default_colors, loaded_colors)
    else
      vim.notify("darcula-dark: " .. err .. ", using default colors", vim.log.levels.WARN)
      color = require("darcula.default_colors")
    end
  else
    color = require("darcula.default_colors")
  end
  ...
  M.configure_highlights(color)
end

---@param color table Color palette
M.configure_highlights = function(color)
  -- colors
  -- Highlight groups
  ...
  if M.config.opt.integrations.nvim_cmp then
    hi(0, "Pmenu", { bg = color.charcoal_gray, ctermbg = 13, ctermfg = 0 })
    hi(0, "PmenuSel", { bg = color.dark_gray_blue, ctermbg = 0, ctermfg = 242 })
  ...
  hi(0, "DefinitionArrow", { fg = color.vivid_pink })
  hi(0, "DefinitionBorder", { fg = color.light_blue })
  hi(0, "DefinitionFile", { bg = color.deep_navy })
  ...
  hi(0, "DiagnosticLineCol", { fg = color.muted_blue_gray })
  hi(0, "DiagnosticMap", { fg = color.light_lavender })
  hi(0, "DiagnosticQuickFix", { bold = true, fg = color.vivid_green })
  ...
  hi(0, "FinderParam", { bg = color.deep_purple, bold = true, fg = color.light_lavender })
  ...
  hi(0, "LspSagaDiagnosticHeader", { fg = color.lime_yellow })
  hi(0, "LspSagaFinderSelection", { bold = true, fg = color.bright_green })
  hi(0, "LspSagaHoverBorder", { fg = color.bright_yellow })
  ...
  hi(0, "OutlineDetail", { fg = color.muted_blue_gray })
  hi(0, "OutlineFoldPrefix", { fg = color.dark_red })
  hi(0, "OutlineIndentEvn", { fg = color.bright_purple })
  hi(0, "OutlineIndentOdd", { fg = color.soft_orange })
  ...
  hi(0, "SniprunFloatingWinErr", { ctermfg = 1, fg = color.deep_red })
  hi(0, "SniprunFloatingWinOk", { ctermfg = 14, fg = color.bright_cyan })
  hi(0, "SniprunVirtualTextErr", { bg = color.deep_red, ctermbg = 1, fg = color.dark })
  ...
  hi(0, "TSFunction", { fg = color.warm_yellow })
  ...
  hi(0, "TSNamespace", { fg = color.soft_green })
  hi(0, "TSNone", { fg = color.grey })
  hi(0, "TSNumber", { fg = color.steel_cyan })
  ...
  hi(0, "TSType", { fg = color.soft_cyan })
  ...
  hi(0, "iCursor", { bg = color.deep_cyan, fg = color.very_light_gray })
