...
M.configure_highlights = function()
  ...
  hi(0, "GitSignsStagedAdd", { bg = color.dark, fg = color._28 })
  hi(0, "GitSignsStagedAddLn", { bg = color.dark, fg = color._28 })
  hi(0, "GitSignsStagedAddNr", { bg = color.dark, fg = color._28 })
