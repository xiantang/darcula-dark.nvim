...
M.configure_highlights = function()
  ...
  hi(0, "BufferDefaultCurrent", { ctermfg = 255, fg = "#eeeeee" })
  ...
  hi(0, "CmpDocumentation", { fg = "#eeeeee" })
  hi(0, "CmpDocumentationBorder", { fg = "#eeeeee" })
  ...
  hi(0, "GitGutterAdd", { fg = "#c9d05c" })
  hi(0, "GitGutterChange", { fg = "#b3deef" })
  hi(0, "GitGutterChangeDelete", { fg = "#d3b987" })
  hi(0, "GitGutterDelete", { fg = "#f43753" })
  hi(0, "GitSignsStagedAdd", { fg = "#64682e" })
  hi(0, "GitSignsStagedAddLn", { fg = "#64682e" })
  hi(0, "GitSignsStagedAddNr", { fg = "#64682e" })
  hi(0, "GitSignsStagedChange", { fg = "#596f77" })
  hi(0, "GitSignsStagedChangeLn", { fg = "#262626" })
  hi(0, "GitSignsStagedChangeNr", { fg = "#596f77" })
  hi(0, "GitSignsStagedChangedelete", { fg = "#596f77" })
  hi(0, "GitSignsStagedChangedeleteLn", { fg = "#262626" })
  hi(0, "GitSignsStagedChangedeleteNr", { fg = "#596f77" })
  hi(0, "GitSignsStagedDelete", { fg = "#7a1b29" })
  hi(0, "GitSignsStagedDeleteNr", { fg = "#7a1b29" })
  hi(0, "GitSignsStagedTopdelete", { fg = "#7a1b29" })
  hi(0, "GitSignsStagedTopdeleteNr", { fg = "#7a1b29" })
  ...
  hi(0, "NormalFloat", { fg = "#eeeeee" })
  hi(0, "NormalNC", { fg = "#eeeeee" })
