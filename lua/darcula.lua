...
M.configure_highlights = function()
  ...
  hi(0, "CmpItemKindKeyword", { fg = color._01 })
  ...
  -- cursor
  hi(0, "Cursor", { bg = color._18, fg = color._02 })
  ...
  hi(0, "DiagnosticUnderlineWarn", { sp = color._01, undercurl = true })
  hi(0, "DiagnosticUnderlineWarning", { sp = color._01, undercurl = true })
  hi(0, "DiagnosticWarn", { ctermfg = 3, fg = color._01 })
  ...
  hi(0, "Error", { bg = color.red, ctermbg = 9, ctermfg = 15, fg = color._02 })
  ...
  hi(0, "EyelinerSecondary", { fg = color._01 })
  ...
  hi(0, "GitGutterAdd", { bg = color._02, fg = color._05 })
  hi(0, "GitGutterChange", { bg = color._02, fg = color.light_blue })
  hi(0, "GitGutterChangeDelete", { bg = color._02, fg = color._01 })
  hi(0, "GitGutterDelete", { bg = color._02, fg = color.red })
  hi(0, "GitSignsStagedAdd", { bg = color._02, fg = color._28 })
  hi(0, "GitSignsStagedAddLn", { bg = color._02, fg = color._28 })
  hi(0, "GitSignsStagedAddNr", { bg = color._02, fg = color._28 })
  hi(0, "GitSignsStagedChange", { bg = color._02, fg = color._24 })
  hi(0, "GitSignsStagedChangeLn", { bg = color._02, fg = color._43 })
  hi(0, "GitSignsStagedChangeNr", { bg = color._02, fg = color._24 })
  hi(0, "GitSignsStagedChangedelete", { bg = color._02, fg = color._24 })
  hi(0, "GitSignsStagedChangedeleteLn", { bg = color._02, fg = color._43 })
  hi(0, "GitSignsStagedChangedeleteNr", { bg = color._02, fg = color._24 })
  hi(0, "GitSignsStagedDelete", { bg = color._02, fg = color._23 })
  hi(0, "GitSignsStagedDeleteNr", { bg = color._02, fg = color._23 })
  hi(0, "GitSignsStagedTopdelete", { bg = color._02, fg = color._23 })
  hi(0, "GitSignsStagedTopdeleteNr", { bg = color._02, fg = color._23 })
  ...
  hi(0, "Ignore", { ctermfg = 0, fg = color._02 })
  ...
  hi(0, "Normal", { bg = color._02, fg = color.grey })
  ...
  hi(0, "NotifyWARNBorder", { fg = color._01 })
  hi(0, "NotifyWARNIcon", { fg = color._01 })
  hi(0, "NotifyWARNTitle", { fg = color._01 })
  hi(0, "Number", { fg = color._08 })
  hi(0, "NvimInternalError", { bg = color.red, ctermbg = 9, ctermfg = 9, fg = color._02 })
  ...
  hi(0, "ScrollbarWarn", { ctermfg = 0, fg = color._01 })
  hi(0, "ScrollbarWarnHandle", { bg = color.background, ctermbg = 15, ctermfg = 0, fg = color._01 })
  ...
  hi(0, "SniprunVirtualTextErr", { bg = color._38, ctermbg = 1, fg = color._06 })
  hi(0, "SniprunVirtualTextOk", { bg = color._40, ctermbg = 14, fg = color._06 })
  ...
  hi(0, "SpellRare", { ctermbg = 13, sp = color._01, undercurl = true })
  ...
  hi(0, "TSKeywordOperator", { fg = color._01 })
  ...
  hi(0, "TSRepeat", { fg = color._01 })
  hi(0, "TSStrike", { fg = color._02, strikethrough = true })
  ...
  hi(0, "TSUnderline", { fg = color._02, underline = true })
  ...
  hi(0, "TermCursor", { bg = color._18, fg = color._02 })
  hi(0, "TermCursorNC", { bg = color._18, fg = color._02 })
  ...
  hi(0, "User2", { bg = color._12, fg = color._01 })
  ...
  hi(0, "User8", { bg = color._12, fg = color._02 })
  hi(0, "User9", { bg = color._12, fg = color._02 })
  ...
  hi(0, "gitcommitHeader", { fg = color._01 })
  ...
  hi(0, "lCursor", { bg = color._18, fg = color._02 })

  -- lualine.nvim
  hi(0, "lualine_a_command", { bg = color.green, bold = true, fg = color._06 })
  hi(0, "lualine_a_inactive", { bg = color._11, bold = true, fg = color._06 })
  hi(0, "lualine_a_insert", { bg = color.green, bold = true, fg = color._06 })
  hi(0, "lualine_a_normal", { bg = color.green, bold = true, fg = color._06 })
  hi(0, "lualine_a_replace", { bg = color.green, bold = true, fg = color._06 })
  hi(0, "lualine_a_visual", { bg = color.green, bold = true, fg = color._06 })
  hi(0, "lualine_b_command", { bg = color.green, fg = color._06 })
  ...
  hi(0, "lualine_b_diagnostics_warn_command", { bg = color.green, fg = color._01 })
  hi(0, "lualine_b_diagnostics_warn_inactive", { bg = color._11, fg = color._01 })
  hi(0, "lualine_b_diagnostics_warn_insert", { bg = color.green, fg = color._01 })
  hi(0, "lualine_b_diagnostics_warn_normal", { bg = color.green, fg = color._01 })
  hi(0, "lualine_b_diagnostics_warn_replace", { bg = color.green, fg = color._01 })
  hi(0, "lualine_b_diagnostics_warn_terminal", { bg = color.green, fg = color._01 })
  hi(0, "lualine_b_diagnostics_warn_visual", { bg = color.green, fg = color._01 })
  ...
  hi(0, "lualine_b_inactive", { bg = color._11, fg = color._06 })
  hi(0, "lualine_b_insert", { bg = color.green, fg = color._06 })
  hi(0, "lualine_b_normal", { bg = color.green, fg = color._06 })
  hi(0, "lualine_b_replace", { bg = color.green, fg = color._06 })
  hi(0, "lualine_b_visual", { bg = color.green, fg = color._06 })
  hi(0, "lualine_c_command", { bg = color.green, fg = color._06 })
  hi(0, "lualine_c_inactive", { bg = color._11, fg = color._06 })
  hi(0, "lualine_c_insert", { bg = color.green, fg = color._06 })
  hi(0, "lualine_c_normal", { bg = color.green, fg = color._06 })
  hi(0, "lualine_c_replace", { bg = color.green, fg = color._06 })
  hi(0, "lualine_c_visual", { bg = color.green, fg = color._06 })
